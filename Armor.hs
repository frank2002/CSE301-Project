...
firts_armor = Armor 5 5 5 "Fists Armor"
...
armor_list = [iron_armor, steel_armor, mithril_armor, dragon_scale, shadow_cloak, celestial_plate, demon_hide, guardian_mail, aegis_shield, titanium_v
